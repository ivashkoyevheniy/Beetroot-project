...
import { Search, Button, Avatar } from "../../assets/commonComponents";
        ...
        <header className="app-header">
            ...
            <div className="right-header-container">
                ...
                <div className="icon-container icon-container--header">
                    ...
                    <span className="position-absolute top-0 start-100 translate-middle bg-primary badge border border-light rounded-circle">
